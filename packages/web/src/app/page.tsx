      ...
      >
        ...
        <div
          style={{
            ...
            borderRadius: "50%",
            background:
              "radial-gradient(circle, rgba(109,40,217,0.22) 0%, transparent 68%)",
            filter: "blur(48px)",
            animation:
              "floatUp 14s ease-in-out infinite, orbPulse 8s ease-in-out infinite",
          }}
        />
        ...
        <div
          style={{
            ...
            borderRadius: "50%",
            background:
              "radial-gradient(circle, rgba(29,78,216,0.18) 0%, transparent 68%)",
            filter: "blur(48px)",
            animation:
              "floatDown 17s ease-in-out infinite, orbPulse 11s ease-in-out infinite 2s",
          }}
        />
        ...
        <div
          style={{
            ...
            borderRadius: "50%",
            background:
              "radial-gradient(circle, rgba(21,128,61,0.14) 0%, transparent 68%)",
            filter: "blur(40px)",
        ...
        <div
          style={{
            ...
            borderRadius: "50%",
            background:
              "radial-gradient(circle, rgba(236,72,153,0.10) 0%, transparent 68%)",
            filter: "blur(32px)",
        ...
        <div
          style={{
            ...
            borderRadius: "50%",
            background:
              "radial-gradient(circle, rgba(6,182,212,0.08) 0%, transparent 68%)",
            filter: "blur(36px)",
        ...
        <div
          style={{
            ...
            height: "1px",
            background:
              "linear-gradient(90deg, transparent, rgba(109,40,217,0.4), rgba(29,78,216,0.4), transparent)",
      ...
      <div style={{ position: "relative", zIndex: 1 }}>
        ...
        <nav className="flex items-center justify-between px-8 py-5 border-b border-zinc-900 sticky top-0 bg-black/80 backdrop-blur-md z-50">
          <div className="flex items-center gap-3">
            ...
            <Badge
              variant="outline"
              className="text-xs border-zinc-800 text-zinc-500 hidden sm:flex"
            >
              Kite testnet
            </Badge>
          </div>
        ...
        >
          ...
          >
            ...
            <path
              ...
              strokeDasharray="1200"
              style={{
                animation: "drawLine 4s ease-out forwards 1.5s",
                strokeDashoffset: 1200,
              }}
            />
            ...
            <path
              ...
              strokeDasharray="1200"
              style={{
                animation: "drawLine 4s ease-out forwards 2.5s",
                strokeDashoffset: 1200,
              }}
            />
          ...
          <div style={{ position: "relative", zIndex: 1 }}>
            ...
            >
              Deploy autonomous agents that monitor markets, detect cross-chain
              arbitrage, and allocate capital across DeFi protocols — with
              cryptographic proof of every decision on Kite chain.
            </p>
        ...
        >
          <div
            style={{
              ...
              boxShadow:
                "0 0 0 1px rgba(109,40,217,0.2), 0 0 80px rgba(109,40,217,0.15), 0 32px 64px rgba(0,0,0,0.6)",
            }}
          >
            {/* Mock browser bar */}
            <div
              ...
              >
                {[
                  ...
                  >
                    ...
                    <p
                      style={{ fontSize: "11px", color: "#3f3f46", margin: 0 }}
                    >
                      {s.sub}
                    </p>
                  </div>
              ...
              {[
                {
                  ...
                  price: "$2,329.18",
                  reason:
                    "Monitoring cross-chain spread for ETH between Avalanche ($2,329.18) and Kite Chain ($2,331.03) — $1.85 spread insufficient after bridge fees.",
                  time: "09:14:53",
                ...
                },
                {
                  ...
                  price: "$10.96",
                  reason:
                    "Allocating to Aave V3 on Ethereum in USDC at 10.96% APY — battle-tested security, $25.7M TVL, medium risk profile preferred over higher-yield alternatives.",
                  time: "09:12:54",
        ...
        <Separator
          style={{ background: "#111", border: "none", height: "1px" }}
        />
            ...
            {[
              {
                ...
                items: [
                  ...
                  "RSI + trend + confidence scoring",
                  "4 assets monitored simultaneously",
                  "Decisions logged to TradeJournal.sol",
                ],
                color: "#15803d",
              },
              {
                ...
                items: [
                  "ETH, BTC, AVAX price comparison",
                  "LayerZero bridge fee calculation",
                  "Profitability threshold filtering",
                  "On-chain opportunity logging",
                ],
                color: "#1d4ed8",
              },
              {
                ...
                items: [
                  "Live DeFiLlama yield feeds",
                  "Risk-adjusted return scoring",
                  "Aave, Morpho, Fluid coverage",
                  "Allocation decisions on Kite chain",
                ],
                color: "#6d28d9",
              },
            ].map((pillar) => (
              <div
                ...
                style={{
                  ...
                  borderRadius: "14px",
                  padding: "40px 32px",
                  boxShadow: `0 0 0 1px rgba(0,0,0,0.3), 0 8px 32px rgba(0,0,0,0.4), inset 0 1px 0 rgba(255,255,255,0.05)`,
                }}
              >
        ...
        >
          ...
          >
            <div>
              ...
              >
                Every agent starts with a $50 sandbox budget. As decisions
                settle and performance builds on ReputationRegistry.sol, budget
                tiers unlock automatically — no human approval, no manual
                review. Your agent&apos;s track record is immutable and
                portable.
              </p>
              <Link href="/launch">
                <button
              ...
              {[
                ...
                <div
                  ...
                  style={{
                    ...
                    border: `1px solid ${t.active ? "rgba(21,128,61,0.45)" : "rgba(255,255,255,0.05)"}`,
                    borderRadius: "10px",
                    boxShadow: t.active
                      ? "0 0 32px rgba(21,128,61,0.2), inset 0 1px 0 rgba(74,222,128,0.1)"
          ...
          >
            ...
            <div
              style={{
                ...
                overflow: "hidden",
                boxShadow:
                  "0 0 0 1px rgba(29,78,216,0.1), 0 0 60px rgba(29,78,216,0.12), 0 24px 48px rgba(0,0,0,0.5)",
              }}
            >
              <div
                style={{
              ...
              >
                <p style={{ color: "#52525b", margin: "0 0 4px" }}>
                  # Step 1 — agent calls Dragent endpoint
                </p>
                ...
                <p style={{ color: "#52525b", margin: "0 0 4px" }}>
                  # Step 3 — agent pays via Kite Passport
                </p>
                <p style={{ color: "#a1a1aa", margin: "0 0 16px" }}>
                  X-Payment: {"<signed_auth>"}
                </p>

                <p style={{ color: "#52525b", margin: "0 0 4px" }}>
                  # Step 4 — strategy parsed, rules returned
                </p>
            ...
            <div>
              ...
              >
                Dragent exposes AI-powered market intelligence as Kite-native
                x402 services. Any agent with a Kite Passport can pay per use —
                no subscriptions, no API keys, fully autonomous
              ...
              >
                {[
                  {
                    endpoint: "POST /api/strategy/parse",
                    price: "1 KITE token",
                    desc: "Parse natural language strategy",
                  },
                  {
                    endpoint: "POST /api/reason/generate",
                    price: "0.5 KITE token",
                    desc: "Generate verifiable trade reasoning",
                  },
                  {
                    endpoint: "GET  /api/reputation/:addr",
                    price: "0.1 KITE token",
                    desc: "On-chain reputation lookup",
                  },
                ].map((ep) => (
                  <div
                    key={ep.endpoint}
            ...
            {[
              {
                ...
                desc: "Every trade, arb scan, and allocation decision indexed in real time. Dashboard reads directly from chain — no centralised database for on-chain data.",
                tag: "Indexing",
              },
              {
                name: "AA SDK (ERC-4337)",
                desc: "Agent transactions submitted as UserOperations via the Kite bundler. Gasless execution, batch operations, upgradeable smart wallets per agent.",
                tag: "Execution",
              },
              {
                name: "DUSD gasless relayer",
                desc: "Dragent operates its own EIP-3009 gasless relayer for DUSD transfers. Users pay zero gas — the relayer sponsors transactions on their behalf.",
                tag: "Gasless",
              },
              {
                name: "TradeJournal.sol",
                desc: "Every decision hashed with keccak256 and committed immutably. Plain-English reasons stored on IPFS, hash on Kite. Tamper-proof, verifiable forever.",
                tag: "Attestation",
              },
              {
                name: "ReputationRegistry.sol",
                desc: "Win rate, drawdown, and Sharpe proxy tracked per agent on-chain. Budget tiers unlock automatically when thresholds are met — no human approval.",
                tag: "Reputation",
              },
              {
                name: "AgentVaultFactory.sol",
                desc: "One transaction deploys a complete vault with programmable spending rules. Each user gets their own isolated contract — full self-custody.",
                tag: "Vaults",
              },
            ].map((item) => (
              <div
        ...
        <section style={{ padding: "60px 32px" }}>
          <div
            style={{
              ...
              borderRadius: "14px",
              overflow: "hidden",
              boxShadow: "0 0 0 1px rgba(255,255,255,0.04), 0 0 60px rgba(109,40,217,0.1)",
            }}
          >
            {[
        ...
        >
          ...
          <div style={{ position: "relative", zIndex: 1 }}>
            ...
            >
              Join early. Build your agent&apos;s on-chain reputation now. Every
              verified decision today unlocks higher capital tiers when
              execution goes live.
            </p>
            <Link href="/launch">
              <button
        ...
        >
          <div style={{ display: "flex", alignItems: "center", gap: "16px" }}>
            <span
              style={{ fontSize: "15px", fontWeight: 500, color: "#a1a1aa" }}
            >
              Dragent
            </span>
            <span style={{ fontSize: "13px", color: "#3f3f46" }}>
              Built natively on Kite chain
            </span>
          </div>
